...
export default function InformalHero({ sequence }: { sequence: SequenceConfig }) {
  const canvasRef = useRef<HTMLCanvasElement>(null);
  const [imagesLoaded, setImagesLoaded] = useState(false);
  const imagesRef = useRef<HTMLImageElement[]>([]);
  const FRAME_COUNT = sequence.frameCount || 171;
  ...
  return (
    <section className="relative h-screen w-full flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-[#121212]/70 via-[#121212]/40 to-[#121212] pointer-events-none" />
      ...
      <div className="relative z-10 text-center px-6 max-w-5xl mx-auto">
        ...
        <motion.p
          ...
          className="geist-mono text-xs md:text-sm tracking-[0.4em] uppercase text-theme-amber/70 mb-8 font-black"
        >
