  ...
  return (
    <section className={cn("py-20 md:py-32 px-6 md:px-24 bg-transparent", className)}>
        ...
        >
            ...
            <motion.div variants={fadeUpVariant} className="md:col-span-2 md:row-span-2 min-h-[400px] md:min-h-0 rounded-[2rem] bg-black/40 backdrop-blur-md border border-white/10 p-8 md:p-10 flex flex-col justify-end relative overflow-hidden hover:border-theme-indigo/50 hover:shadow-[0_0_30px_rgba(99,102,241,0.15)] transition-all duration-500">
               <motion.div 
            ...
            {/* About / Identity Card */}
            <motion.div variants={fadeUpVariant} className="md:col-span-2 md:row-span-1 rounded-[2rem] bg-white/5 border border-white/10 p-8 flex flex-col justify-center group transition-colors hover:bg-theme-indigo/5">
            ...
            {/* Photo 1 Placeholder */}
            <motion.div variants={fadeUpVariant} className="md:col-span-1 md:row-span-1 min-h-[250px] md:min-h-0 rounded-[2rem] bg-white/5 border border-white/10 relative overflow-hidden group hover:border-theme-amber/50 transition-colors">
            ...
            {/* Photo 2 Placeholder */}
            <motion.div variants={fadeUpVariant} className="md:col-span-1 md:row-span-1 min-h-[250px] md:min-h-0 rounded-[2rem] bg-white/5 border border-white/10 relative overflow-hidden group hover:border-theme-indigo/50 transition-colors">
